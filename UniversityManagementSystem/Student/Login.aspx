<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="UniversityManagementSystem.Student.Login" %>
                ...
                <div class="login-form">
                    <form id="form1" runat="server">
                        ...
                        <div class="form-group">
                           ...
                           <asp:Button ID="B1"  class="btn btn-success btn-flat m-b-30 m-t-30" runat="server" Text="Sign In" OnClick="B1_Click" />
                               <center><a href="StudentRegistration.aspx">Register Now</a></center>
